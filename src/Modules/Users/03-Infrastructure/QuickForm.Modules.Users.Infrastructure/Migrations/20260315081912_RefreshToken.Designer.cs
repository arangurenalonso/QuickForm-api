...
namespace QuickForm.Modules.Users.Persistence.Migrations
{
    ...
    [Migration("20260315081912_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickForm.Modules.Users.Domain.AuthActionTokenDomain", b =>
                {
                    ...
                    b.HasIndex("IdUserAction", "TokenHash");

                    b.HasIndex("IdUser", "IdUserAction", "Used", "ExpiresAt");
            ...
            modelBuilder.Entity("QuickForm.Modules.Users.Domain.RefreshTokenDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_RefreshTokenDomain_IsDeleted");
                    ...
                    b.OwnsOne("QuickForm.Common.Domain.KeyNameVO", "KeyName", b1 =>
                        {
                            ...
                            b1.HasIndex("Value")
                                .HasDatabaseName("IX_ApplicationDomain_KeyName");
                    ...
                    b.OwnsOne("QuickForm.Common.Domain.KeyNameVO", "KeyName", b1 =>
                        {
                            ...
                            b1.HasIndex("Value")
                                .HasDatabaseName("IX_AuthActionDomain_KeyName");
                    ...
                    b.OwnsOne("QuickForm.Common.Domain.KeyNameVO", "KeyName", b1 =>
                        {
                            ...
                            b1.HasIndex("Value")
                                .HasDatabaseName("IX_PermissionsActionsDomain_KeyName");
                    ...
                    b.OwnsOne("QuickForm.Common.Domain.KeyNameVO", "KeyName", b1 =>
                        {
                            ...
                            b1.HasIndex("Value")
                                .HasDatabaseName("IX_ResourcesDomain_KeyName");
                    ...
                    b.OwnsOne("QuickForm.Common.Domain.KeyNameVO", "KeyName", b1 =>
                        {
                            ...
                            b1.HasIndex("Value")
                                .HasDatabaseName("IX_RoleDomain_KeyName");
